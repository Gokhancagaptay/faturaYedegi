...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      // 1) Backend'e kullanıcıyı e-posta/telefon + şifre ile kaydet
      await _apiService.registerWithPassword(
      ...
      // 2) Telefon doğrulamasını başlat (opsiyonel ama önerilir)
      await _firebaseService.startPhoneVerification(
        ...
        onFailed: (msg) {
          // Telefon doğrulama başarısız olsa bile e-posta/şifre ile giriş yapılabilir
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('SMS doğrulama başlatılamadı: $msg')),
          );
        },
      );
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    // Web ve büyük ekranlar için responsive layout
        ...
        children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Hesap oluşturun ve modern fatura yönetimi deneyimini keşfedin. Kağıtsız, hızlı ve güvenli.',
                      style: TextStyle(
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Center(
                child: Container(
                  width: 450, // Form için sabit genişlik
